...
def main(args):
    ...
    partition_name = f"num_clients-{args.client_num_in_total}" 
    root_dir = _CURRENT_DIR.parent / args.dataset / partition_name
    ...
    with open(root_dir / "partition.pkl", "wb") as f:
        pickle.dump(partition, f)

    with open(root_dir / "all_stats.json", "w") as f:
        json.dump(stats, f)
